...
-- 11055-000-9806 was not in Plex.accounting_account_year_category_type for 2022 and 2023 but is for 2024 and 2025
--Start here: noticed this in Plex.account_period_balance_recreate_open_period_range so decided to come here 
--Why is 202212 present but not 202301-202310?	
-- Bug fix need end_open_period in case account gets added in January and Dec of previous year is closed but January is open.
--select *	
--from Plex.account_period_balance b 	
--where account_no = '11055-000-9806'
--MISSING account_year_category_type 2022 record for the new account
...
-- 11055-000-9806 was not in Plex.accounting_account_year_category_type for 2023 but is for 2024 and 2025
--Now there is a Plex.accounting_account_year_category_type record for 2022, 2024, and 2025 but still no 2023 record.
-- delete 
--select * 
...
-- Bug missing Plex.account_period_balance records for new account_no = '11055-000-9806' for period_start to period_end	
/*
